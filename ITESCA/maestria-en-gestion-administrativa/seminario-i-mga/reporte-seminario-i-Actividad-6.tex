...
\textbf{Producto:} Versión LaTeX de la Actividad 6 con la plantilla institucional ITESCA utilizada en las otras actividades de Seminario I. Conserva el material, las adaptaciones y las referencias del documento Word preparado para el curso.

\textbf{Alcance:} El índice de esta versión se genera con LaTeX. La consigna del aula exige un archivo Word con índice automatizado en Word; el DOCX original se conserva por separado y no se sustituye por este PDF.
\end{abstractd}
